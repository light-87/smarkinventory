...
// The 0018 HOURS balance (computeCompBalanceHours) was retired by migration
// 0020: comp-off is a DAY ledger now. Its rules are covered by
// tests/unit/attendance-comp-days.test.ts.
