...
export function Th({
  ...
  return (
    <th
      className={cn(
        "border-b border-charcoal bg-canvas px-3.5 py-[11px] text-[11px] font-medium tracking-[0.04em] whitespace-nowrap text-smoke uppercase",
...
export function Td({
  ...
  return (
    <td
      className={cn(
        "border-b border-border-hairline px-3.5 py-[11px] text-[13px] text-silver-mist",
        mono && "font-mono",
        align === "right" && "text-right",
        align === "center" && "text-center",
        className,
