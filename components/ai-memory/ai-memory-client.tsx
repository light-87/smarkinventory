  ...
  return (
    <div className="mx-auto max-w-[960px] px-6 py-7 pb-24">
      <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="rounded-full border border-charcoal px-3.5 py-[5px] font-mono text-[15px] text-silver-mist">
          Rules v{digestVersion}
        </span>
      </div>
      <p className="mb-6 max-w-[640px] text-[15px] text-smoke">
      ...
      {suggested.length > 0 && (
        <div className="mb-8">
          <div className="mb-3 text-[13px] tracking-[0.06em] text-smark-orange uppercase">
