    ...
    <Card>
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <form method="get" action="/daily" className="flex flex-wrap items-center gap-2">
          <input type="date" name="date" defaultValue={viewedDate} className="h-9 rounded-lg border border-charcoal bg-surface-well px-3 text-[15px] text-snow outline-none focus:border-smark-orange" />
          {showPersonFilter && (
            <select
              name="person"
