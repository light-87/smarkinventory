              ...
              <div className="bg-surface-panel border-t border-border-divider px-5 py-4">
                <div className="flex flex-wrap items-end gap-3">
                  <div className="min-w-[200px] flex-1">
                    <div className="mb-1.5 text-[15px] text-silver-mist">Existing box</div>
                    <NativeSelect
                      options={boxOptions}
                      value={boxId}
                      onChange={(e) => {
                  ...
                  <div className="min-w-[140px]">
                    <div className="mb-1.5 text-[15px] text-silver-mist">New box name</div>
                    <Input
                      value={newBoxName}
                      onChange={(e) => {
                  ...
                  <div className="min-w-[100px]">
                    <div className="mb-1.5 text-[15px] text-silver-mist">Shelf</div>
                    <Input value={shelfCode} onChange={(e) => setShelfCode(e.target.value)} placeholder="A" mono />
                  </div>
                  <div className="min-w-[160px] flex-1">
                    <div className="mb-1.5 text-[15px] text-silver-mist">ESD note (optional)</div>
