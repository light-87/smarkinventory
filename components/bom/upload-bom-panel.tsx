    ...
    <Card padding="lg">
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          />
          <div className="text-[17px] text-snow">{fileName ?? "Drop your filled template here"}</div>
          <div className="mt-1.5 text-[15px] text-smoke">{fileName ? "Tap to choose a different file" : ".xlsx only"}</div>
        </div>
