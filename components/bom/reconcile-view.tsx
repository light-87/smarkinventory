    ...
    <div className="flex flex-col gap-5">
      {bom.priority_notes && (
        <Card tone="panel">
          ...
          <div className="mt-1 text-[15px] text-snow">{bom.priority_notes}</div>
        </Card>
      )}

      <Card padding="lg" className="flex flex-wrap items-end gap-3">
        <div className="flex flex-col gap-1.5">
          <label className="text-[15px] text-silver-mist">Build qty ×N</label>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {reviewRunId && (
            <Link
              ...
              className="inline-flex h-9 items-center rounded-full bg-smark-orange/15 px-3.5 text-[15px] font-medium text-smark-orange transition-colors hover:bg-smark-orange/25"
            >
              In review →
            </Link>
          )}
