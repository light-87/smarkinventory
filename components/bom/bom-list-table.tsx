                ...
                <div className="flex items-center gap-2">
                  ...
                  {reviewRunIdByBom?.get(bom.id) && (
                    <button
                      ...
                      className="inline-flex h-7 items-center rounded-full bg-smark-orange/15 px-2.5 text-[14px] font-medium text-smark-orange transition-colors hover:bg-smark-orange/25"
                    >
                      In review →
                    </button>
                  )}
                  ...
                  <div className="flex items-center justify-end gap-1">
                    {archivedView ? (
                      <button
                        ...
                        disabled={archiving}
                        className="inline-flex h-9 items-center justify-center rounded-full px-3 text-[14px] font-medium text-smoke transition-colors hover:bg-charcoal hover:text-snow disabled:opacity-50"
                      >
                        Restore
                      </button>
                    ) : (
