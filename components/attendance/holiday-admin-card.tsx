  ...
  return (
    <Card padding="none">
      ...
      <div className="flex flex-col gap-5 px-5 py-[18px]">
        <div>
          <div className="mb-2 text-[13px] font-medium text-snow">Weekly off</div>
          <div className="flex flex-wrap gap-2">
            {WEEKDAY_NAMES.map((label, weekday) => (
              <button
                ...
                className={`h-9 min-w-11 cursor-pointer rounded-full border px-3 text-[13px] transition-colors disabled:opacity-50 ${
        ...
        <div className="border-t border-border-faint pt-4">
          <div className="mb-2 text-[13px] font-medium text-snow">Add a specific date</div>
        ...
        <div className="border-t border-border-faint pt-4">
          <div className="mb-2 text-[13px] font-medium text-snow">Upcoming / all specific dates</div>
          {specific.length === 0 ? (
              ...
              {specific.map((h) => (
                <div key={h.id} className="flex items-center justify-between gap-3 rounded-xl border border-charcoal bg-surface-panel px-4 py-2.5">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[13px] text-snow">{h.name}</span>
                  </div>
