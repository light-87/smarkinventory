...
/**
 * Package-local styled `<select>` for the attendance surface. components/ui has
 * no dropdown primitive, and docs/OWNERSHIP.md forbids importing another
 * package's local one — so this mirrors that treatment. Matches the Input
