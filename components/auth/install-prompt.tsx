...
export function InstallPrompt() {
  ...
  if (deferred) {
    return (
      <div className="mt-5 flex items-center justify-between gap-3 rounded-xl border border-charcoal bg-surface-panel px-4 py-3">
        <span className="text-[13px] text-silver-mist">Install SmarkStock on this device</span>
        <Button
  ...
  if (isIosUserAgent()) {
    return (
      <div className="mt-5 rounded-xl border border-charcoal bg-surface-panel px-4 py-3 text-[13px] text-silver-mist">
