    ...
    <div className="flex flex-col gap-4">
      {pendingPutAway && (
        <Link
          ...
          className="rounded-xl border border-smark-orange bg-surface-accent px-4 py-3 text-[13px] text-snow no-underline transition-colors hover:bg-surface-accent-hover"
        >
