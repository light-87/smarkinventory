...
export function LocationsTable({ locations, className }: LocationsTableProps) {
  ...
  return (
    <div className={cn("overflow-hidden rounded-lg border border-charcoal", className)}>
      <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-2 border-b border-border-divider bg-surface-raised px-3.5 py-2.5 text-[12px] tracking-[0.04em] text-smoke uppercase">
      ...
      {locations.map((location) => (
        ...
        >
          <span className="truncate text-[14px] text-snow">
          ...
          <span className="text-right font-mono text-[14px] text-snow">
