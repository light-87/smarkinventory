...
-- ----------------------------------------------------------------------------
create table public.smark_overtime (
...
create index idx_smark_overtime_user on public.smark_overtime (user_id);
create index idx_smark_overtime_date on public.smark_overtime (work_date);
create index idx_smark_overtime_status on public.smark_overtime (status);
...
-- ----------------------------------------------------------------------------
-- 3. smark_notifications.kind — add the two overtime kinds (0009 already
--    recreated this constraint with the leave/comp kinds).
-- ----------------------------------------------------------------------------
