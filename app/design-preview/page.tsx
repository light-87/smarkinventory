    ...
    <main className="mx-auto flex max-w-5xl flex-col gap-14 px-6 py-12 pb-32">
      ...
      <Section title="Card" description="Elevation is a 1px charcoal border on a #141414 surface — never a shadow.">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Card>
            <div className="text-[15px] text-smoke">Plain card</div>
            <div className="mt-1 text-[17px] text-snow">
              Default padding, surface tone
            </div>
          </Card>
          <Card tone="panel" interactive>
            <div className="text-[15px] text-smoke">Interactive · panel tone</div>
            <div className="mt-1 text-[17px] text-snow">Hover to lift the border</div>
          </Card>
          <Card padding="none">
...
function Swatch({
  ...
  return (
    <div className="w-20 flex-none">
      ...
      <div className="mt-1.5 truncate text-[13px] text-smoke">{name}</div>
    </div>
  );
}
...
function SegmentedDemo() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <div className="mb-2 text-[13px] tracking-[0.06em] text-smoke uppercase">
      ...
      <Drawer open={open} onClose={() => setOpen(false)} aria-label="Part detail">
        <DrawerHeader>
          <div className="min-w-0">
            ...
            <div className="mt-1 truncate font-mono text-[15px] text-silver-mist">
              GRM188R71H104KA93D
            </div>
            <div className="mt-0.5 text-[15px] text-smoke">Murata</div>
          </div>
          ...
          <div className="mb-6 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-border-divider bg-border-divider">
            {[
              ...
              <div key={k} className="bg-surface px-3.5 py-[11px]">
                <div className="mb-1 text-[13px] text-smoke">{k}</div>
                <div className="text-sm text-snow">{v}</div>
              </div>
            ))}
          </div>
          <SectionLabel className="mb-3">Locations</SectionLabel>
          <div className="rounded-lg border border-charcoal p-3.5 text-[15px] text-silver-mist">
